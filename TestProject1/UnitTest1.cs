...
namespace UnitTestRestaurant
{
    ...
    {
        public clsSystem system = new clsSystem();
        ...
        public void GetFldEmployer_ValidIndex_EmployerReturned()
        {
            ...
            string retrievedEmployer = system.FldMyEmployer[employerIndex].GetName() +" "+ system.FldMyEmployer[employerIndex].GetLastName();
        ...
        public void UpdateEmployer_ValidParameters_EmployerUpdated()
        {
            ...
            Assert.AreEqual($"{updatedName} {updatedLastName}", system.FldMyEmployer[0].GetName() + " " + system.FldMyEmployer[0].GetLastName());
        }
